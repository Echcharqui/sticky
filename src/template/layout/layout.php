            ...
            <nav>
                <div class="nav-wrapper blue-grey darken-4">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <?php if (Utilities::isAuthenticated()) : ?>
                            <li><a href="/settings" class="<?= Utilities::urlIs('/settings') ? 'cyan-text accent-3' : '' ?>">settings</a></li>
                            <li><a href="/logout" class="red-text">logout</a></li>
                        <?php else : ?>
                            <li><a href="/login" class="<?= Utilities::urlIs('/login') ? 'cyan-text accent-3' : '' ?>">login</a></li>
                            <li><a href="/registration" class="<?= Utilities::urlIs('/registration') ? 'cyan-text accent-3' : '' ?>">registration</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </nav>
